...
def replaceFunction(matchObj):
	...
	# split() used because Infobox are followed by a name before | occurs
...
def parseWikipediaText(text):
	...
	references, text = getReferencesText(referencesSectionText, text)
